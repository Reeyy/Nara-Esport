...
<body>
    <header>
     ...
     Email / Password wrong please re-login !!!
            ...
            INNER
            JOIN team
            on team.TEAM_ID =schedule.SCHE_Team_ID";
                        ...
                        <table>
                            <thead>
                                <tr class="table100-head">
                                    <th class="column1">Schedule id</th>
                            ...
                            <tbody>
                                ...
                                while ($row = mysqli_fetch_array($result)) {
                                    echo '<tr>
                                                <th class="column1">' . $row['SCHE_ID'] . '</th>
                                                <th class="column2">' . $row['TEAM_Name'] . '</th>
                                                <th class="column3">' . $row['SCHE_Activity'] . '</th>
                                                <th class="column3">' . $row['SCHE_Date'] . '</th>
                                                <th class="column3">' . $row['SCHE_Location'] . '</th>
